...
namespace Bardolf69\CountriesStatesCities;

use Bardolf69\CountriesStatesCities\Commands\CountriesStatesCitiesSeederCommand;
        ...
        $package
            ...
            ->hasInstallCommand(function (InstallCommand $command) {
                $command
                    ...
                    ->askToRunMigrations()
                    ->askToStarRepoOnGitHub('bardolf69/laravel-countries-states-cities');
            });
    }
